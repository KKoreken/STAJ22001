            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Açtığım Ticketlar</h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-inline mb-0">
                                                @if($t->is_locked!='1')<li class="list-inline-item">
                                                    <a href="{{url('edit-ticket').'/'.$t->uuid}}" class="px-2 text-primary"><i
                                                ...
                                                <li class="list-inline-item dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        @if($t->status == 'Cevaplandı')<a class="dropdown-item" href="{{url('my-ticket-history').'/'.$t->uuid}}">Mesaj Detaylari</a>@endif
                                                    </div>
                                                </li>
                                            </ul>
                                        </td>

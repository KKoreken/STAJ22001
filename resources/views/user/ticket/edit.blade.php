            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('edit-ticket-post')}}" method="post"> @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input value="{{$ticket->title}}" name="title" type="text" class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea  id="message" name="message" class="form-control" rows="2">{{$ticket->message}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">

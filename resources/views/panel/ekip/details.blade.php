                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex mb-4 justify-content-between" >
                            <h5 class="card-title ">Ekip Adı</h5>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap"
                                                ...
                                                @foreach($uyeler as $uye)
                                                    <tr>
                                                        <td>{{ $uye['user']->name }}</td>
                                                        <td>{{ $uye['totalIsSayisi'] }}</td>
                                                        <td>{{ $uye['aktifIsSayisi'] }}</td>
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end " style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(-40px, 30px, 0px);" data-popper-placement="bottom-end">
                                                                    <a class="dropdown-item" href="{{route('panel-user-details',['id'=>$uye['user']->id])}}">İncele</a>
                                                                    <a class="dropdown-item" href="{{route('panel-user-edit',['id'=>$uye['user']->id])}}">Düzenle</a>
                                                                    <div class="dropdown-divider"></div>
                                                                    <a class="dropdown-item" href="#">Ekipten Çıkar</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>

                    ...
                    <div class="card-body">
                        ...
                        <div class="chat-leftsidebar me-4">
                            <div class="card mb-0">
                                ...
                                <form id="projectForm" method="POST" action="{{ route('panel-squad-store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="tab-pane active show" id="genelbilgi" role="tabpanel">
                                            <div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-floating mb-3">
                                                            <input required type="text" class="form-control" name="ekip_adi" id="floatingFirstnameInput" placeholder="Ekip Adı Giriniz">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-floating mb-3">
                                                            <select name="departman" id="floatingFirstnameInput" class="form-control">
                                                                    <option selected disabled>Departman Seçiniz</option>
                                                                @foreach($departmans as $d)
                                                                    <option value="{{$d->id}}">{{$d->baslik}}</option>
                                                                @endforeach
                                                            </select>
                                        ...
                                        <div class="tab-pane " id="isler" role="tabpanel">
                                            <div class="card-body">
                                                    ...
                                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <select class="form-select" name="users[0][user]">
    ...
    @section('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                <tr>
                    <td>
                        <select class="form-select" name="users[${jobCount}][user]">
                            <option value="" disabled selected>Kullanici Seçiniz</option>
                                 @foreach($users as $u)
                                <option value="{{$u->id}}">{{$u->name}}</option>
                                 @endforeach

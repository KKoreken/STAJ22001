            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{route('panel-squad-add')}}"><button  class="btn btn-success" id="btn-save-event">Yeni Ekle</button></a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end " style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(-40px, 30px, 0px);" data-popper-placement="bottom-end">
                                                <a class="dropdown-item" href="{{route('panel-squad-details',['id'=>$squad->id])}}">İncele</a>
                                                <a class="dropdown-item" href="{{route('panel-squad-edit',['id'=>$squad->id])}}">Düzenle</a>

...
@section('body')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{route('addFile')}}"><button  class="btn btn-success" id="btn-save-event">Yeni Ekle</button></a>
                    </div>
                    <div class="card-body">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="{{url('Panel/Dosya-Yoneticisi/Sil')}}/{{$i->id}}"><i class="mdi mdi-delete"></i> Sil</a>
                                            <a class="dropdown-item" href="{{url('storage/app')}}/{{$i->url}}"><i class="mdi mdi-delete"></i> Goster</a>
                                            <p class="dropdown-item" onclick="copyUrlWithPrefix('{{$i->url}}')">
                                                <i class="mdi mdi-delete"></i> Kopyala
                                            </p>
                                        </div>
                                    </div>
                                </td>
    ...
    @section('scripts')
        ...
        <script>
            function copyUrlWithPrefix(url) {
                // Mevcut sitenin ana sayfa linkini al
                const siteUrl = window.location.origin;
                // URL'nin başına site adını ekle
                const fullUrl = `${siteUrl}/storage/app/${url}`;

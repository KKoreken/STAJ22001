            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('addProjectPost')}}" method="post" enctype="multipart/form-data">@csrf
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="my-3" >
                                    <label for="lang_cover"><h5 class="card-title">Yazılım Dili</h5></label>
                                    <select class="form-control" name="lang_cover" id="lang_cover">
                                        <option value="cover1.img">Laravel</option>
                                    </select>
                                </div>
                                <div>

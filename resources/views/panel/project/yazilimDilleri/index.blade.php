            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{route('addProject')}}"><button  class="btn btn-success" id="btn-save-event">Yeni Ekle</button></a>
                    </div>
                    <div class="card-body">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="{{url('Panel/Proje-Duzenle/')}}/{{$i->id}}"><i class="mdi mdi-pencil"></i> Düzenle</a>
                                            <a class="dropdown-item" href="{{url('Panel/Proje-Sil/')}}/{{$i->id}}"><i class="mdi mdi-delete"></i> Sil</a>
                                        </div>
                                    </div>
                                </td>
